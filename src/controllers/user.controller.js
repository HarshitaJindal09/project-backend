...
// This function is responsible for using the refresh token to generate a new access token when the old access token expires.
...
const refreshAccessToken = asyncHandler(async (req, res) => 
{
    ...
    // created the refresh token earlier using generaterefreshtoken
    try{
        ...
        // Token coming from the client !== Token stored in MongoDB
